...
export default function Home() {
    ...
    return (
        <div className={styles.page}>
            ...
            <Card image='https://cf.bstatic.com/xdata/images/hotel/square240/404175626.webp?k=dcff45977a0f5ecd2cc5bab01829eb7df21a228b44c80a06054e24efebf53fe0&o=' title='Pousada Alto Da Boa Vista' rating={5} city='Campos do Jordäo' state='SP' price='658' />
                {hotels.map(
                    (hotel, index) => (
